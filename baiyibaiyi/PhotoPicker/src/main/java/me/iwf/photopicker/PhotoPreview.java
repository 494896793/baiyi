...
public class PhotoPreview {
    ...
    public final static String EXTRA_ALL_PHOTOS = "allPhotos";
    ...
    public static class PhotoPreviewBuilder {
        ...
        public void start(@NonNull Activity activity, Class toActivity, int requestCode) {
            activity.startActivityForResult(getIntent(activity, toActivity), requestCode);
        }
        public void start(@NonNull Activity activity,@NonNull Fragment fragment, Class toActivity, int requestCode) {
            fragment.startActivityForResult(getIntent(activity, toActivity), requestCode);
        }
        ...
        public void start(@NonNull Activity activity, Class toActivity) {
            start(activity, toActivity, REQUEST_CODE);
        }
        public void start(@NonNull Activity activity,@NonNull Fragment fragment, Class toActivity) {
            start(activity,fragment, toActivity, REQUEST_CODE);
        }
        ...
        public Intent getIntent(@NonNull Context context, Class toActivity) {
            mPreviewIntent.setClass(context, toActivity);
            mPreviewIntent.putExtras(mPreviewOptionsBundle);
            return mPreviewIntent;
        }
        ...
        public PhotoPreviewBuilder setAllPhotos(ArrayList<String> allPhotoPaths) {
            mPreviewOptionsBundle.putStringArrayList(EXTRA_ALL_PHOTOS, allPhotoPaths);
            return this;
        }
