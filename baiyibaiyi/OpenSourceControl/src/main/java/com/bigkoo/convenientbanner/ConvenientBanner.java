...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private OnCBScrollListener mOnCBScrollListener;
...
//    }
    ...
    public void setOnCBScrollListener(OnCBScrollListener onCBScrollListener){
        this.mOnCBScrollListener = onCBScrollListener;
    }
    ...
    public boolean onTouchEvent(MotionEvent arg0) {
        ...
        switch (arg0.getAction()){
            case MotionEvent.ACTION_DOWN:
               try{ mOnCBScrollListener.onDown();}catch (Throwable t){t.printStackTrace();}//
                break;
            case MotionEvent.ACTION_UP:
                mOnCBScrollListener.onUp();
                break;
            case MotionEvent.ACTION_MOVE:
                mOnCBScrollListener.onMove();
                break;
        }
        return super.onTouchEvent(arg0);
    }

    public interface OnCBScrollListener{
        void onDown();
        void onMove();
        void onUp();
    }
