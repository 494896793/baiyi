...
import me.iwf.photopicker.PhotoPickerPagerActivity;
...
public class PhotoPickerFragment extends Fragment {
    ...
    private PopupWindowWrap listPopupWindow;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listPopupWindow = new PopupWindowWrap(getActivity());
        listPopupWindow
                .setContentView(R.layout.__picker_ppw_photo_dir, new PopupWindowWrap.OnCreatedPPWListener() {
                    @Override
                    public void onCreatedPPW(View contentView) {
                        ListView lvPhotoDir = (ListView) contentView.findViewById(R.id.lvPhotoDir);
                        lvPhotoDir.setAdapter(listAdapter);
                        lvPhotoDir.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
        ...
        photoGridAdapter.setOnPhotoClickListener(new OnPhotoClickListener() {
            ...
            public void onClick(View v, int position, boolean showCamera) {
                final int index = showCamera ? position - 1 : position;//当前位置
...
//                ((PhotoPickerActivity) getActivity()).addImagePagerFragment(imagePagerFragment);
                ...
                PhotoPreview.builder()
                        .setPhotos(selectedPhotoPaths)
                        .setAllPhotos(photos)
                        .setCurrentItem(index)
                        .start(getActivity(), PhotoPickerFragment.this, PhotoPickerPagerActivity.class);
            }
        });
    ...
    private void showPhotoDir(View btSwitchDirectory) {
        listPopupWindow.showAtLocation(btSwitchDirectory, Gravity.BOTTOM, 0, 0);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            } else if (null != data && requestCode == PhotoPreview.REQUEST_CODE) {//预览后返回到该页面
                boolean isClickComplete = data.getBooleanExtra("isClickComplete", false);
                if (isClickComplete) {
                    ...
                    photoGridAdapter.setData(paths);

                    if (getActivity() instanceof PhotoPickerActivity) {
                        ((PhotoPickerActivity) getActivity()).updateSelectPhone(paths);
                    }
                }
            }
        }
