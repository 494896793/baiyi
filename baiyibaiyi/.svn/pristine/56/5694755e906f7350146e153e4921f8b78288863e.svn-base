...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
    ...
    public void setData(ArrayList<String> selectedPhotos) {
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == ITEM_TYPE_PHOTO) {
            ...
            if (isChecked) {
                holder.vSelected.setImageResource(R.drawable.__picker_pic_checked);
            } else {
                holder.vSelected.setImageResource(R.drawable.__picker_pic_unchecked);
            }
            ...
            holder.vSelected.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (onItemCheckListener != null) {
                        List<String> paths = getSelectedPhotos();
