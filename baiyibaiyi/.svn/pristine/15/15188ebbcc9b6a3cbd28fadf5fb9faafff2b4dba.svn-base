...
-keepclassmembers class com.baogang.bycx.activity.WebActivity {
   public *;
}
...
-keep class com.baogang.bycx.callback.** { *; } #实体类不参与混淆
-keep class com.baogang.bycx.request.** { *; } #实体类不参与混淆
...
# Retain generic shareType information for use by reflection by converters and adapters.
...
#flowlayout
-dontwarn cn.lankton.flowlayout.**
-keep public class cn.lankton.flowlayout.**{*;}
