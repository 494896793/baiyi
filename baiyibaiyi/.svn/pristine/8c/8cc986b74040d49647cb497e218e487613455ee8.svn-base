...
public class ReturnCarSuccessBillLongRentActivity extends BaseActivity {
    ...
    private double getActualPayMoney() {
        ...
        if(couponValue>0&&billLongRentResp!=null&&!TextUtils.isEmpty(billLongRentResp.getTransferMoney())){
            temperaTotal=temperaTotal-Integer.valueOf(billLongRentResp.getTransferMoney())/100;
        }
        ...
        if(couponValue>0&&billLongRentResp!=null&&!TextUtils.isEmpty(billLongRentResp.getTransferMoney())){
            payMoney=payMoney+Integer.valueOf(billLongRentResp.getTransferMoney())/100;
        }
