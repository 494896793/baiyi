...
public class LableViewGroup extends ViewGroup {
     ...
     * @param defStyle
     */
    public LableViewGroup(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public LableViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
