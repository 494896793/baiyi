    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    showToasts(allCity_lists.get(position).getName());
                }
            }
        });
        locateProcess = 1;
...
//				Toast.makeText(getApplicationContext(),city_result.get(position).getName(), Toast.LENGTH_SHORT).show();
                showToasts(city_result.get(position).getName());
            }
        });
        initOverlay();
        cityInit();
            ...
            if (viewType == 0) {
                ...
                hotCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        showToasts(city_hot.get(position).getName());
