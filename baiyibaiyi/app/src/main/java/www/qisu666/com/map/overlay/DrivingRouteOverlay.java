package www.qisu666.com.map.overlay;
...
import www.qisu666.com.map.util.AMapUtil;
...
public class DrivingRouteOverlay extends RouteOverlay {
     ...
     * 添加驾车路线添加到地图上显示。
     */
    public void addToMap(Marker myStartMarker, Marker myEndMarker) {
        initPolylineOptions();
        try {
            if (mAMap == null) {
                return;
            ...
            addStartAndEndMarker(myStartMarker, myEndMarker);
    ...
    private BitmapDescriptor getThroughPointBitDes() {
        return BitmapDescriptorFactory.fromResource(R.mipmap.marker_has_car);
