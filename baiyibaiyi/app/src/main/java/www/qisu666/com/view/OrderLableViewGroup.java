...
public class OrderLableViewGroup extends ViewGroup {
    private static final int PADDING_HOR = 9;//水平方向padding
     ...
     * @param context
     */
    public OrderLableViewGroup(Context context) {
        super(context);
    }
     ...
     * @param defStyle
     */
    public OrderLableViewGroup(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public OrderLableViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
