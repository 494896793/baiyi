 ...
 * 带标题可滑动
 */
class ViewPagerWithTitleViews : LinearLayout {
    ...
    private fun init() {
        ...
        layoutInflater.inflate(R.layout.view_viewpager_with_title, this)
    }
...
//            setTitleItemColor(index)
        ...
        viewPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                secondSetTitleItemColor(position);
